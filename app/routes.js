...
// message board AFFIRMATION PAGE routes ===============================================================
    ...
    app.post('/messages', (req, res) => {
      db.collection('messages').save({name: req.body.name, msg: req.body.msg, date: req.body.date, avail: req.body.avail}, (err, result) => {
        if (err) return console.log(err)
    ...
    app.post('/messagesMood', (req, res) => {
      db.collection('messagesMood').save({date: req.body.date, time: req.body.time, msg: req.body.msg, guard: req.body.guard, name: req.body.name}, (err, result) => {
        if (err) return console.log(err)
         console.log('saved to database')
